...
namespace CnControls
{
	...
	public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
	{
		...
		/// </summary>
		public string HorizontalAxisName = "CameraX";

		/// <summary>
		/// The name of the vertical axis for this joystick to update
		/// </summary>
		public string VerticalAxisName = "CameraY";
...
//			var horizontalValue = Mathf.Clamp (difference.x * _oneOverMovementRange, -3f, 3f);
			var horizontalValue = difference.x * _oneOverMovementRange;
//			var verticalValue = Mathf.Clamp (difference.y * _oneOverMovementRange, -3f, 3f);
			var verticalValue = difference.y * _oneOverMovementRange;
